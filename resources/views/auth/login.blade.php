                        ...
                        <div>
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <input type="email" id="email" name="email" value="{{ old('email') }}" required autofocus placeholder="info@gmail.com"
                            ...
                            <div class="mt-5">
                                <p class="text-center text-sm font-normal text-gray-700 sm:text-start">
                                    ...
                                    <a href="{{ route('register') }}" class="text-brand-500 hover:text-brand-600">Sign Up</a>
                                </p>
                            </div>
                        </div>
                    </div>
